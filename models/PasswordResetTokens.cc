...
const std::string &PasswordResetTokens::getValueOfToken() const noexcept
{
...
const std::shared_ptr<std::string> &PasswordResetTokens::getToken() const noexcept
{
    return token_;
}
void PasswordResetTokens::setToken(const std::string &pToken) noexcept
{
    token_ = std::make_shared<std::string>(pToken);
    dirtyFlag_[2] = true;
}
void PasswordResetTokens::setToken(std::string &&pToken) noexcept
{
    token_ = std::make_shared<std::string>(std::move(pToken));
    dirtyFlag_[2] = true;
}

const ::trantor::Date &PasswordResetTokens::getValueOfExpiresAt() const noexcept
{
...
const std::shared_ptr<::trantor::Date> &PasswordResetTokens::getExpiresAt() const noexcept
{
    return expiresAt_;
}
void PasswordResetTokens::setExpiresAt(const ::trantor::Date &pExpiresAt) noexcept
{
