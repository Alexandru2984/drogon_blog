...
class Likes
{
  public:
     ...
     */
    explicit Likes(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Likes(const Json::Value &pJson) noexcept(false);
     ...
     */
    Likes(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Likes>;
    friend drogon::orm::BaseBuilder<Likes, true, true>;
    friend drogon::orm::BaseBuilder<Likes, true, false>;
    friend drogon::orm::BaseBuilder<Likes, false, true>;
    friend drogon::orm::BaseBuilder<Likes, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Likes>;
#endif
